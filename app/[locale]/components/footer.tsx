        ...
        <footer className="bg-[#000000] dark:bg-gray-900 mt-lg">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    ...
                    <div className="grid md:grid-cols-4 gap-4 sm:gap-6 sm:grid-cols-3 ">
                        <div>
                        ...
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase text-white">Nous suivre</h2>
                            <div className="flex md:justify-left mt-4 sm:justify-center sm:mt-0">

                                <div className="m-1">
                                    <Tooltip props={<svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
                                ...
                                <div className="m-1">
                                    <Tooltip props={<svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 17">
                                ...
                                <div className="m-1">
                                    ...
                                    <Tooltip props={<svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 25 17">
